...
export default function Home() {
  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-between p-4">
      <div className="flex flex-col gap-16 max-w-3xl pt-16">
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormDescription>
                      Your name according to your NRIC.
                    </FormDescription>
                    <FormMessage />
                  </FormItem>
                )}
                ...
                render={() => (
                  <FormItem>
                    <div className="grid space-y-1.5 mb-4">
                      ...
                      <FormDescription>
                        Your surname or family name. Include Bin, Bte, D/O, S/O
                        if applicable.
                      </FormDescription>
                    </div>
        ...
        <section className="grid space-y-4">
          <p className="text-muted-foreground text-sm">
            ...
            a personal project and is not an official tool associated
            with/developed by the SAF.{" "}
          </p>
          <a
            className="text-muted-foreground text-sm underline"
            href="https://github.com/jeffsieu/saf-name-tag"
            target="_blank"
          >
            Source code
          </a>
